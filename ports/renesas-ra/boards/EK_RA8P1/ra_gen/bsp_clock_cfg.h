...
/* CHANGED: PLL source moved from MAIN_OSC (24 MHz XTAL) to HOCO (48 MHz internal) to
 * avoid main-oscillator stabilization hang in bsp_clock_init MOSCSF wait on this
 * board. HOCO 48 MHz / DIV_3 = 16 MHz PLL input; MUL x125 → 2000 MHz PLL output
 * (same as before). Original values preserved as comments. */
#define BSP_CFG_PLL_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_HOCO) /* PLL Src: HOCO (was MAIN_OSC) */
#define BSP_CFG_PLL_DIV (BSP_CLOCKS_PLL_DIV_3) /* PLL Div /3 */
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(125,0) /* PLL Mul x125.00 from HOCO (was x250.00 from MAIN_OSC) */
...
/* CHANGED: same as PLL1 — PLL2 source moved from MAIN_OSC to HOCO. */
#define BSP_CFG_PLL2_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_HOCO) /* PLL2 Src: HOCO (was MAIN_OSC) */
#define BSP_CFG_PLL2_DIV (BSP_CLOCKS_PLL_DIV_3) /* PLL2 Div /3 */
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(150,0) /* PLL2 Mul x150.00 from HOCO (was x300.00 from MAIN_OSC) */
